...
?>
    ...
    <div class="container text-center" style="margin-top:5rem;">
        <div class="row">
            <div class="col">
                <span class="fs-2 fw-bold">Nombre: </span><span class="fs-3"><?php echo $row ['nombre'];?></span>
            </div>
            <div class="col">
    ...
    <div class="container text-start">
        <div class="row">
            ...
            <div class="col">
                <span class="fs-4 fw-bold">Recompensa: </span><span class="fs-5">$
                    <?php echo number_format($row ['recompensa']);?></span>
            </div>
            <div class="col">
    ...
    <div class="container text-start">
        <div class="row">
            ...
            <div class="col">
                <span class="fs-4 fw-bold">Delegación/Municipio de extravio: </span><span
                    class="fs-5"><?php echo $row ['dom'];?></span>
            </div>
            <div class="col">
                <span class="fs-4 fw-bold">Estatus: </span><span
                    class="fs-5"><?php echo $row ['estatus'] ? "Extraviado" : "Encontrado";?></span>
            </div>
        </div>
    </div>
    <br>
        ...
        <div class="row">
            <div class="col">
                <?php if ($row ['estatus'] == '0') {
                    echo "<p class='fw-bold fs-4'>Ya fue encontrado!!!</p>";
                } else {
                    echo "<form action='./BDcomentarioMascota.php' method='post'>
                    <div class='form-floating'>
                    <textarea class='form-control' name='descripcion' placeholder='Descripción'
                        id='floatingTextarea'></textarea>
                    <label for='floatingTextarea'>Comentario sobre extravio</label>
                </div>
                <input type='text' value=' $id' name='id' hidden>
                <input type='text' value=' $usuario' name='usuario' hidden>
                <input type='text' value='$nombre $apellido' name='nombre' hidden>
                <br>
                <button type='submit' class='btn btn-outline-success float-end' id='btnfrm'>Enivar
                    comentario</button>
                </form>";
                }
                ?>
