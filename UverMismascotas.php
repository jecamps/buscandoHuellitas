...
<body>
    <!-- Tabla mis mascotas -->
    <div class="container table-responsive" style="margin-top:4rem;margin-bottom:4rem;">
        <table id="tablax" class="display table table-hover">
            <thead>
                <tr>
                    <th scope="col"></th>
                    <th scope="col">Nombre</th>
                    <th scope="col">Fecha de extravio</th>
            ...
            <?php
              ...
              FROM `mascotas` WHERE `usuario` = '$nombre'";
            ...
            ?>
                <tr>
                    ...
                    <td>$ <?php echo number_format($row ['recompensa']);?></td>
                    <td><a href="./Uvercomentarios.php?id=<?php echo $row["id"];?>"><i class="bi bi-chat-right fw-bold"
                                style="color:green; font-size:1.5rem;"></i></a>
                    </td>
                    <td><a href="./UdetallesMascota.php?id=<?php echo $row["id"];?>"><i class="bi bi-pencil-square"
